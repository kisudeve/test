      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex pr-2 select-none gap-2 sm:gap-4">
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <span className="text-xs sm:text-sm text-gray-600 font-medium">UP</span>
          </div>
          <div className="flex items-center gap-1 sm:gap-2">
            <div className="w-3 h-3 rounded-full bg-blue-500"></div>
            <span className="text-xs sm:text-sm text-gray-600 font-medium">DOWN</span>
          </div>
          <div className="flex items-center gap-1 sm:gap-2">
            <div className="w-3 h-3 rounded-full bg-black"></div>
            <span className="text-xs sm:text-sm text-gray-600 font-medium">HOLD</span>
          </div>
        </div>
      </div>
      {/* 차트 */}
