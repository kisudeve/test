...
export default function CommentChildClient({
  ...
  return (
    <li
      className={twMerge(
        "relative pl-16",
        "after:w-10 after:h-3 after:absolute after:left-6 after:top-3",
        "after:border-l after:border-b after:rounded-bl-4xl",
        "after:border-slate-200 dark:after:border-[#364153]",
        "last-of-type:before:absolute last-of-type:before:w-px",
        "last-of-type:before:h-[calc(100%-15px)]",
        "last-of-type:before:bg-white last-of-type:before:left-6 last-of-type:before:bottom-0",
        "dark:last-of-type:before:bg-[#141d2b]",
      )}
    >
